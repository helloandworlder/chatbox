...
abstract class $SearchResultCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String snippet, String url, String? rawContent});
}
...
class _$SearchResultImpl implements _SearchResult {
  ...
  @override
  String toString() {
    return 'SearchResult(title: $title, snippet: $snippet, url: $url, rawContent: $rawContent)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, snippet, url, rawContent);
...
abstract class _SearchResult implements SearchResult {
  const factory _SearchResult(
      ...
      final String? rawContent}) = _$SearchResultImpl;
